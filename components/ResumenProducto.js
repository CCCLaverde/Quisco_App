...
export const ResumenProducto = ({producto}) => {
  ...
  const { hadleEditarCantidades, handleEliminarProducto } = useQuiosco()
    ...
    <div className='shadow p-5 mb-3 flex gap-10 items-center'>
      ...
      <div>
        <button 
          ...
          onClick={() => hadleEditarCantidades(producto.id)}
        >
        ...
        <button 
          type='button'
          className='bg-red-700 flex gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full mt-4'
